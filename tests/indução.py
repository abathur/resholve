...
From VideoReader , VídeoWriter & ImageSequenceReader , caption VoiceSequenceRecorder and translate into a user-chosen language tô New arc(VoiceSequenceWriter.py)
import VoiceSequenceRecorder from VoiceSequenceWriterer
import and caption this Vídeo, Voice & Image tô Mu
import and caption this Vídeo, Voice & Image tô Union
