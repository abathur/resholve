#!/nix/store/d50mzwc57fgc6j1gf320hcwc81k0jdph-bash-4.4-p23/bin/sh
...
__SHUNIT_UNAME_S=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/uname -s`
...
if command [ -n "${ZSH_VERSION:-}" ]; then
  setopt |/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep "^shwordsplit$" >/dev/null
...
__shunit_constants=`set |/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep '^__SHUNIT_' |/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/cut -d= -f1`
echo "${__shunit_constants}" |/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep '^Binary file' >/dev/null && \
    __shunit_constants=`set |/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep -a '^__SHUNIT_' |/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/cut -d= -f1`
...
assertContains() {
  ...
  shunit_return=${SHUNIT_TRUE}
  if echo "$shunit_container_" | /nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep -F -- "$shunit_content_" > /dev/null; then
    _shunit_assertPass
  else
...
assertTrue() {
  ...
  shunit_match_=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${shunit_condition_}" : '\([0-9]*\)'`
  shunit_return=${SHUNIT_TRUE}
...
suite_addTest() {
  ...
  __shunit_testsTotal=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr ${__shunit_testsTotal} + 1`
...
_shunit_mktempDir() {
  ...
  ( exec /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/mktemp -dqt shunit.XXXXXX 2>/dev/null ) && return

  # The standard `mktemp` didn't work. Use our own.
  # shellcheck disable=SC2039
  if command [ -r '/dev/urandom' -a -x 'od' ]; then
    _shunit_random_=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/od -vAn -N4 -tx4 </dev/urandom \
        |command /nix/store/3lx9p6hw67mjk430gdazjgg3g6j6cvn1-gnused-4.8/bin/sed 's/^[^0-9a-f]*//'`
  elif command [ -n "${RANDOM:-}" ]; then
    # $RANDOM works
    _shunit_random_=${RANDOM}${RANDOM}${RANDOM}$$
  else
    # `$RANDOM` doesn't work.
    _shunit_date_=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/date '+%Y%m%d%H%M%S'`
    _shunit_random_=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${_shunit_date_}" / $$`
  fi

  _shunit_tmpDir_="${TMPDIR:-/tmp}/shunit.${_shunit_random_}"
  ( umask 077 && command /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/mkdir "${_shunit_tmpDir_}" ) || \
...
_shunit_mktempFunc() {
  ...
  do
    ...
    command /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/cat <<EOF >"${_shunit_file_}"
#! /bin/sh
exit ${SHUNIT_TRUE}
EOF
    command /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/chmod +x "${_shunit_file_}"
  done
...
_shunit_cleanup() {
  ...
  if command [ ${__shunit_clean} -eq ${SHUNIT_FALSE} ]; then
    ...
    command /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/rm -fr "${__shunit_tmpDir}"
  fi
...
_shunit_execSuite() {
  for _shunit_test_ in ${__shunit_suite}; do
    ...
    if command [ ${__shunit_testSuccess} -eq ${SHUNIT_TRUE} ]; then
      __shunit_testsPassed=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr ${__shunit_testsPassed} + 1`
    else
      __shunit_testsFailed=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr ${__shunit_testsFailed} + 1`
    fi
  done
...
#   None
_shunit_assertPass() {
  __shunit_assertsPassed=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr ${__shunit_assertsPassed} + 1`
  __shunit_assertsTotal=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr ${__shunit_assertsTotal} + 1`
}
...
#   none
_shunit_incFailedCount() {
  __shunit_assertsFailed=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${__shunit_assertsFailed}" + 1`
  __shunit_assertsTotal=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${__shunit_assertsTotal}" + 1`
}
...
#   None
_shunit_assertSkip() {
  __shunit_assertsSkipped=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${__shunit_assertsSkipped}" + 1`
  __shunit_assertsTotal=`/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr "${__shunit_assertsTotal}" + 1`
}
...
_shunit_escapeCharInStr() {
  ...
  echo ''${_shunit_s_}'' |command /nix/store/3lx9p6hw67mjk430gdazjgg3g6j6cvn1-gnused-4.8/bin/sed 's/\'${_shunit_c_}'/\\\'${_shunit_c_}'/g'
...
_shunit_extractTestFunctions() {
  ...
  /nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/egrep "${_shunit_regex_}" "${_shunit_script_}" \
  |command /nix/store/3lx9p6hw67mjk430gdazjgg3g6j6cvn1-gnused-4.8/bin/sed 's/^[^A-Za-z0-9_-]*//;s/^function //;s/\([A-Za-z0-9_-]*\).*/\1/g' \
  |/nix/store/6akcfhcz3y41ba2kw15vzzlz3jpbsj2c-findutils-4.7.0/bin/xargs
...
command /nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/mkdir "${SHUNIT_TMPDIR}"
...
# resholve: allow eval:_shunit_test_
# resholve: allow eval:shunit_condition_
# resholve: allow function:noexec
# resholve: allow function:oneTimeSetUp
# resholve: allow function:oneTimeTearDown
# resholve: allow function:setUp
# resholve: allow function:suite
# resholve: allow function:tearDown
# resholve: allow resholved_inputs:/nix/store/3lx9p6hw67mjk430gdazjgg3g6j6cvn1-gnused-4.8/bin/sed
# resholve: allow resholved_inputs:/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/egrep
# resholve: allow resholved_inputs:/nix/store/60mzdl1220sl7r48ra9kn5ms8xg6vzxj-gnugrep-3.4/bin/grep
# resholve: allow resholved_inputs:/nix/store/6akcfhcz3y41ba2kw15vzzlz3jpbsj2c-findutils-4.7.0/bin/xargs
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/cat
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/chmod
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/cut
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/date
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/expr
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/mkdir
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/mktemp
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/od
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/rm
# resholve: allow resholved_inputs:/nix/store/9ic69cjkf5q6mqssac076drxrgs2s0nh-coreutils-8.31/bin/uname
