...
--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < which_simple.sh (exit: 3) ]
...
--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < command_in_function.sh (exit: 3) ]
...
>>> #!/nix/store/...-bash-5.1-p8/bin/bash
>>> source /private/tmp/nix-build-resholve-test.drv-0/resholved/tests/file_simple.sh

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 2 Even in a function, 'which' needs to be in RESHOLVE_PATH in 303ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < absolute_path.sh (exit: 5) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 3 Absolute executable paths need exemptions in 344ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < absolute_path_nested.sh (exit: 5) ]
...
>>> Next step: keep, fix, or pre-patch/substitute it.
>>> #!/nix/store/...-bash-5.1-p8/bin/bash
>>> /nix/store/...-findutils-4.8.0/bin/find

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 4 Even nested-executable paths need exemptions in 310ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < source_var_pwd.sh (exit: 6) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 5 Source, among others, needs an exemption for arguments containing variables in 302ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < file_simple.sh (exit: 0) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 6 Resolves unqualified 'file' to absolute path from RESHOLVE_PATH in 304ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < file_in_function.sh (exit: 0) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 7 Even in a function, resolves unqualified 'file' to absolute path from RESHOLVE_PATH in 320ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < file_home_source_pwd.sh (exit: 6) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 8 Only some commands ('source' but NOT 'file', here) are checked for variable arguments. in 300ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash --keep 'source:$PWD' < file_home_source_pwd.sh (exit: 0) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 9 Add an exemption with --keep <scope>:<name> in 304ms

--[ RESHOLVE_KEEP='source:$PWD' resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < file_home_source_pwd.sh (exit: 0) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 10 Add an exemption with RESHOLVE_ALLOW=source:$PWD in 316ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < source_missing_target.sh (exit: 4) ]
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 11 'source' targets also need to be in RESHOLVE_PATH in 296ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < source_present_target.sh (exit: 0) ]
...
--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash --fix aliases < alias_riddle.sh (exit: 0) ]
...
>>> +alias find="/nix/store/...-findutils-4.8.0/bin/find -H" find2="/nix/store/...-findutils-4.8.0/bin/find -P" # external!
>>>  
>>>  function file(){
>>>  	file -n # the alias :P
>>>  }
...
>>> +\/nix/store/...-findutils-4.8.0/bin/find# external
>>> +command /nix/store/...-findutils-4.8.0/bin/find # external
>>> +
>>> +### resholve directives (auto-generated) ## format_version: 2
>>> +# resholve: fix aliases
>>> +# resholve: keep /nix/store/...-findutils-4.8.0/bin/find
>>> +# resholve: keep /nix/store/...-file-5.41/bin/file

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 13 Has (naive) context-specific resolution rules in 371ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash < nested_execer.sh (exit: 0) ]
...
>>> +echo wert | /nix/store/...-findutils-4.8.0/bin/find $(type -p file) -name file -exec /nix/store/...-file-5.41/bin/file {} +  # resolve 1st/~last
>>>  echo wert | fargs file # resolve none
>>> -echo wert | exec find file # resolve 2nd
>>> -echo wert | xargs file # resolve both
>>> +echo wert | exec /nix/store/...-findutils-4.8.0/bin/find file # resolve 2nd
>>> +echo wert | /nix/store/...-findutils-4.8.0/bin/xargs /nix/store/...-file-5.41/bin/file # resolve both
>>>  
...
>>> +	-c "/nix/store/...-bash-5.1-p8/bin/bash -c /nix/store/...-file-5.41/bin/file"
>>> +
>>> +### resholve directives (auto-generated) ## format_version: 2
>>> +# resholve: keep /nix/store/...-findutils-4.8.0/bin/find
>>> +# resholve: keep /nix/store/...-findutils-4.8.0/bin/xargs
>>> +# resholve: keep /nix/store/...-file-5.41/bin/file
>>> +# resholve: keep /nix/store/...-bash-5.1-p8/bin/bash
>>> +# resholve: keep source:/nix/store/...-gettext-0.21/bin/gettext.sh

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ok 14 Has (rudimentary) support for resolving executable arguments in 402ms

--[ resholve --interpreter /nix/store/...-bash-5.1-p8/bin/bash --fix '$FILE_CMD:file' < file_var.sh (exit: 0) ]
...
+++++ set +x
test_openssl
+++++ /nix/store/...-openssl-1.1.1l-bin/bin/openssl version
...
+++++ /nix/store/...-libressl-3.4.1-bin/bin/openssl version
LibreSSL 3.4.1
+++++ set +x
...
───────┼────────────────────────────────────────────────────────────────────────
   1   │ #!/nix/store/...-bash-5.1-p8/bin/bash
...
───────┼────────────────────────────────────────────────────────────────────────
   1   │ openssl_sh() {
   2   │     set -x
   3   │     /nix/store/...-openssl-1.1.1l-bin/bin/openssl version
   4   │     set +x
   5   │ }
   6   │ alias blah=/nix/store/...-openssl-1.1.1l-bin/bin/openssl
   7   │ 
  ...
  12   │ # resholve: keep /nix/store/...-openssl-1.1.1l-bin/bin/openssl
...
───────┼────────────────────────────────────────────────────────────────────────
   ...
   6   │     /nix/store/...-libressl-3.4.1-bin/bin/openssl version
   7   │     set +x
   8   │ }
   9   │ 
  ...
  16   │ # resholve: keep /nix/store/...-libressl-3.4.1-bin/bin/openssl
